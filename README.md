...
[![npm](https://img.shields.io/npm/v/@diotoborg/ratione-animi.svg)](https://www.npmjs.com/package/@diotoborg/ratione-animi)
[![downloads](https://img.shields.io/npm/dt/@diotoborg/ratione-animi.svg)](https://www.npmjs.com/package/@diotoborg/ratione-animi)
[![types](https://img.shields.io/npm/types/@diotoborg/ratione-animi.svg)](https://www.npmjs.com/package/@diotoborg/ratione-animi)
[![licence](https://img.shields.io/github/license/mnasyrov/@diotoborg/ratione-animi.svg)](https://github.com/diotoborg/ratione-animi/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@diotoborg/ratione-animi/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@diotoborg/ratione-animi?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@diotoborg/ratione-animi**][@diotoborg/ratione-animi/docs]             | Core elements, state and effect management | [Docs][@diotoborg/ratione-animi/docs], [API][@diotoborg/ratione-animi/api]             |
| [**@diotoborg/ratione-animi-react**][@diotoborg/ratione-animi-react/docs] | Tooling for React.js                       | [Docs][@diotoborg/ratione-animi-react/docs], [API][@diotoborg/ratione-animi-react/api] |
...
```
npm install @diotoborg/ratione-animi @diotoborg/ratione-animi-react --save
```
...
import { useConst, useObservable, useQuery } from '@diotoborg/ratione-animi-react';
...
[@diotoborg/ratione-animi/docs]: packages/@diotoborg/ratione-animi/README.md
[@diotoborg/ratione-animi/api]: packages/@diotoborg/ratione-animi/docs/README.md
[@diotoborg/ratione-animi-react/docs]: packages/@diotoborg/ratione-animi-react/README.md
[@diotoborg/ratione-animi-react/api]: packages/@diotoborg/ratione-animi-react/docs/README.md
